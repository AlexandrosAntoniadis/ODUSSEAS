...
│ --skip-ew-measurements    --no-skip-ew-measurements                                                 [default: no-skip-ew-measurements]           │
...
We can also choose to do r.v. correction to our spectra if they are shifted, by setting to 'yes' the "rv_cor" option.
