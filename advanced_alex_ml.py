...
df = pd.read_csv('res'+resonumber+"_linerangefor"+inst+'_EWPar.csv')
print('res'+resonumber+"_linerangefor"+inst+'_EWPar.csv')
df.dropna(axis=1, inplace=True)




newdf = pd.read_csv(inst+'_messed_newstars.csv')
